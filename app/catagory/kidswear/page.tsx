...
export default function KidswearPage() {
  const products = [
    { id: 1, name: 'Kids T-shirt', price: '500', image: '/image/kidswear-tshirt.jpg' },
    { id: 2, name: 'Kids Shoes', price: '1200', image: '/image/kidswear-shoes.jpg' },
    { id: 3, name: 'Kids Jeans', price: '800', image: '/image/kidswear-jeans.jpg' },
  ];

  return (
    <div className="category-page">
      <h1 className="text-3xl font-bold mb-6 text-center">Kidswear Collection</h1>
